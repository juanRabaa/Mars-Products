...
class RB_Metabox extends RB_Form_Field_Controller{
    ...
    public function get_metabox_id(){ return $this->id . '_metabox'; }
    ...
    public function add_metabox(){
        ...
        add_meta_box( $this->get_metabox_id(), $title, array($this, 'render_metabox'), $admin_page, $context, $priority);
    ...
    public function add_metabox_classes(){
        ...
        */
        if( is_array($this->metabox_settings['classes']) ){
            add_filter( "postbox_classes_{$this->metabox_settings['admin_page']}_{$this->get_metabox_id()}", function( $classes = array() ){
